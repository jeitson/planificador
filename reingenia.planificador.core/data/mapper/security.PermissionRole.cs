...
namespace reingenia.planificador.Data.mapper.security
{
    ...
    internal class PermissionRoleMapper : EntityTypeConfiguration<PermissionRoleBE>
    {

        public PermissionRoleMapper()
        {
            this.ToTable("PermissionRole", "security");

            this.HasKey(x => x.Id);

            this.Property(x => x.Id).HasColumnName("Id");
            this.Property(x => x.Name).HasColumnName("Name");
            this.Property(x => x.PermissionEntityId).HasColumnName("PermissionEntityId");
            this.Property(x => x.RoleId).HasColumnName("RoleId");
            this.Property(x => x.LevelId).HasColumnName("LevelId");
