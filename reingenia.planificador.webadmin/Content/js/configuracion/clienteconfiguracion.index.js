...
jsClienteConfiguracion.Funcion =
{
    onLoadIndex: function ()
    {
        ...
        $("#formClienteConfiguracionBusqueda").ajaxForm(jsCustom.Funcion.getOptionsAjaxForm(this, "formClienteConfiguracionBusqueda"));
    ...
    setTableIndex: function(nropaginas, tipoorden, columnaorden)
    {
        ...
        jsCustom.Funcion.setDataTable("tableClienteConfiguracionIndex", columns, isOrderJS);
        jsCustom.Funcion.setOrderTable("tableClienteConfiguracionIndex", isOrderJS, tipoorden, columnaorden);
    },

    setFormSubmit: function(form)
    {
    	if (form == "formClienteConfiguracionBusqueda")
            jsCustom.Funcion.clearInputText(form, jsClienteConfiguracion.variables.inputtextpaginate, "1");
    ...
    successForm: function(formId, data)
    {
        ...
        if (formId == "formClienteConfiguracionBusqueda")
        {
            ...
            if (html != "")
                $("#divClienteConfiguracionListaBusqueda").html(html);
            ...
            if (formId == "formClienteConfiguracionBusqueda")
                $("#modalClienteConfiguracionSearch").modal("hide");
        }
    },
    ...
    {
        var form = "formClienteConfiguracionBusqueda";
