...
jsCampana.Funcion =
{
    onLoadIndex: function ()
    {
        ...
        $("#formCampanaBusqueda").ajaxForm(jsCustom.Funcion.getOptionsAjaxForm(this, "formCampanaBusqueda"));
    ...
    setTableIndex: function(nropaginas, tipoorden, columnaorden)
    {
        ...
        jsCustom.Funcion.setDataTable("tableCampanaIndex", columns, isOrderJS);
        jsCustom.Funcion.setOrderTable("tableCampanaIndex", isOrderJS, tipoorden, columnaorden);
    },

    setFormSubmit: function(form)
    {
    	if (form == "formCampanaBusqueda")
            jsCustom.Funcion.clearInputText(form, jsCampana.variables.inputtextpaginate, "1");
