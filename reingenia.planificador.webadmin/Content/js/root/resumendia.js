if (typeof (jsResumenDia) == "undefined")
{
    jsResumenDia = {};
}

jsResumenDia.variable =
{
...
jsResumenDia.Funcion =
{
    ...
    {
        var ok = false;
        var result = jsCustom.Funcion.getJSONURL(jsResumenDia.variable.urlFuerzaComercialTipoEstado);
    ...
    {
        var result = jsCustom.Funcion.getJSONURL(jsResumenDia.variable.urlPendienteRetroalimentada);
    ...
    {
        var result = jsCustom.Funcion.getJSONURL(jsResumenDia.variable.urlPosicionPendiente);
    ...
    {
        var result = jsCustom.Funcion.getJSONURL(jsResumenDia.variable.urlPosicionRetroalimentada);
    ...
    posicion: function (lstBE, tipo)
    {
        ...
        {
            var map = new google.maps.Map(document.getElementById(tipo), {
                center: new google.maps.LatLng(parseFloat(jsResumenDia.variable.defaultLatitud), parseFloat(jsResumenDia.variable.defaultLongitud)),
                zoom: 15
            });
        }
    },
