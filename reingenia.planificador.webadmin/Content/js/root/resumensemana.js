if (typeof (jsResumenSemana) == "undefined")
{
    jsResumenSemana = {};
}

jsResumenSemana.variable =
{
...
jsResumenSemana.Funcion =
{
    ...
    {
        var result = jsCustom.Funcion.getJSONURL(jsResumenSemana.variable.urlFuerzaComercialTipoEstado);
    ...
    {
        var result = jsCustom.Funcion.getJSONURL(jsResumenSemana.variable.urlPendienteRetroalimentada);
    ...
    {
        var result = jsCustom.Funcion.getJSONURL(jsResumenSemana.variable.urlPosicionPendiente);
    ...
    {
        var result = jsCustom.Funcion.getJSONURL(jsResumenSemana.variable.urlPosicionRetroalimentada);
    ...
    posicion: function (lstBE, tipo)
    {
        ...
        {
            var map = new google.maps.Map(document.getElementById(tipo), {
                center: new google.maps.LatLng(parseFloat(jsResumenSemana.variable.defaultLatitud), parseFloat(jsResumenSemana.variable.defaultLongitud)),
                zoom: 15
            });
        }
    },
